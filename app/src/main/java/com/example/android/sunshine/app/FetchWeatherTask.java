...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        long locationId = getLocationId(locationSetting, cityName, lat, lon);
        if (locationId != -1) return locationId;

        insertLocation(locationSetting, cityName, lat, lon);
        return getLocationId(locationSetting, cityName, lat, lon);
    }

    private void insertLocation(String locationSetting, String cityName, double lat, double lon) {
    ...
    private long getLocationId(String locationSetting, String cityName, double lat, double lon) {
        Cursor cursor = null;
        try {
            cursor = mContext.getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI,
                        ...
                        new String[]{locationSetting, cityName, Double.toString(lat), Double.toString(lon)},
                        null);
